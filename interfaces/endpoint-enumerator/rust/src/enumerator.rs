...
pub struct EnumerateEndpointsResponse {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub subdomains: Option<Subdomains>,
                ...
                match __i {
                    ...
                    1 => {
                            ...
                            == d.datatype()?
                        {
                            ...
                            Some(Some( decode_subdomains(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Subdomains': {}", e))? ))
                        }
                    }
    ...
    let __result = {
        if let Some(n) = d.array()? {
            ...
            for _ in 0..(n as usize) {
                arr.push(decode_finding(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Finding': {}", e))?)
            }
            arr
        } else {
            // indefinite array
            ...
            loop {
                match d.datatype() {
                                ...
                                Ok(_) => arr.push(decode_finding(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Finding': {}", e))?)
                            }
            }
            arr
        }
                ...
                match __i {
                    0 => {
                            ...
                            == d.datatype()?
                        {
                            ...
                            Some(Some( decode_findings(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Findings': {}", e))? ))
                        }
                    }
...
pub fn decode_ports(
    ...
    let __result = {
        if let Some(n) = d.array()? {
            ...
            for _ in 0..(n as usize) {
                arr.push(decode_port(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Port': {}", e))?)
            }
            arr
        } else {
            // indefinite array
            ...
            loop {
                match d.datatype() {
                                Err(_) => break,
                                Ok(wasmbus_rpc::cbor::Type::Break) => break,
                                Ok(_) => arr.push(decode_port(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Port': {}", e))?)
                            }
            }
            arr
        }
...
pub fn decode_subdomain(
    ...
    let __result = {
        ...
        if is_array {
            ...
            for __i in 0..(len as usize) {
                match __i {
            0 => open_ports = Some(decode_ports(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Ports': {}", e))?),1 => subdomain = Some(d.str()?.to_string()),
                    _ => d.skip()?,
                    }
            }
        } else {
            ...
            for __i in 0..(len as usize) {
                match d.str()? {
                "openPorts" => open_ports = Some(decode_ports(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Ports': {}", e))?),"subdomain" => subdomain = Some(d.str()?.to_string()),         _ => d.skip()?,
                    }
            }
        }
        Subdomain {
...
pub fn decode_subdomains(
    ...
    let __result = {
        if let Some(n) = d.array()? {
            ...
            for _ in 0..(n as usize) {
                arr.push(decode_subdomain(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Subdomain': {}", e))?)
            }
            arr
        } else {
            // indefinite array
            ...
            loop {
                match d.datatype() {
                                Err(_) => break,
                                Ok(wasmbus_rpc::cbor::Type::Break) => break,
                                Ok(_) => arr.push(decode_subdomain(d).map_err(|e| format!("decoding 'jclmnop.provider.endpoint_enumerator#Subdomain': {}", e))?)
                            }
            }
            arr
        }
